...
# Generated by qmake (3.0) (Qt 5.0.1) on: Tue Aug 5 00:56:28 2014
# Project:  window.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile window.pro
#############################################################################
...
Makefile: window.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/window1.0.0 || $(MKDIR) .tmp/window1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/window1.0.0/ && $(COPY_FILE) --parents window.h question.h tester.h .tmp/window1.0.0/ && $(COPY_FILE) --parents guimain.cpp window.cpp question.cpp tester.cpp .tmp/window1.0.0/ && (cd `dirname .tmp/window1.0.0` && $(TAR) window1.0.0.tar window1.0.0 && $(COMPRESS) window1.0.0.tar) && $(MOVE) `dirname .tmp/window1.0.0`/window1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/window1.0.0
...
guimain.o: guimain.cpp /usr/include/qt5/QtWidgets/QApplication \
...
window.o: window.cpp /usr/include/qt5/QtWidgets/QtWidgets \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/widgets/dialogs/findfiles || $(MKDIR) $(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/widgets/dialogs/findfiles 
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/widgets/dialogs/findfiles/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/widgets/dialogs/findfiles/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/widgets/dialogs/findfiles/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/widgets/dialogs/findfiles/ 
