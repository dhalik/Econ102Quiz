...
# Generated by qmake (3.0) (Qt 5.0.1) on: Tue Aug 5 00:10:06 2014
# Project:  window.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/window1.0.0/ && $(COPY_FILE) --parents window.h question.h .tmp/window1.0.0/ && $(COPY_FILE) --parents guimain.cpp window.cpp question.cpp .tmp/window1.0.0/ && (cd `dirname .tmp/window1.0.0` && $(TAR) window1.0.0.tar window1.0.0 && $(COMPRESS) window1.0.0.tar) && $(MOVE) `dirname .tmp/window1.0.0`/window1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/window1.0.0
